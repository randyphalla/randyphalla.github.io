/* empty css                           */import { _ as __astro_tag_component__, c as createAstro, a as createComponent, r as renderTemplate, b as renderComponent, d as renderSlot, e as renderHead, f as addAttribute, m as maybeRenderHead } from '../astro.c5c4d63d.mjs';
import 'html-escaper';
...
const Header = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [/* @__PURE__ */ jsxs("header", {
      ...
      className: `mobile-menu md:hidden fixed inset-0 bg-gray-900 dark:bg-gray-900 transition-all ${isMobileMenuOpen ? "opacity-100 z-10" : "opacity-0"}`,
