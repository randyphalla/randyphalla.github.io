...
import { e as createAstro, f as createComponent, r as renderTemplate, h as addAttribute, i as renderComponent, j as renderSlot, k as renderTransition, l as renderHead, n as fade, m as maybeRenderHead } from '../astro_5ed3e2b8.mjs';
...
import 'clsx';
import '../index.60d38bcd_2bdff64f.mjs';
import { Transition, Dialog } from '@headlessui/react';
import { $ as $$Image } from './generic_f7953fb9.mjs';
        ...
        children: /* @__PURE__ */ jsxs(Dialog.Panel, { className: "flex justify-center items-center flex-col md:flex-row w-full max-w-4xl	transform overflow-hidden p-6 rounded-lg bg-white dark:dark:bg-gray-900 shadow-xl transition-all", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "w-full md:max-w-lg md:pl-6", children: [
            ...
            portfolio?.repoLink && /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx("a", { className: "text-gray-600 dark:text-gray-400 text-sm md:text-base transition-all hover:text-gray-500", href: portfolio?.repoLink, target: "_blank", children: portfolio?.repoLink })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-4 dark:text-white text-lg md:text-xl font-bold", children: "Project overview:" }),
            /* @__PURE__ */ jsx(Dialog.Description, { className: "text-gray-600 dark:text-gray-400 text-sm md:text-base", children: portfolio?.description }),
            ...
            children: /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("h4", { className: "mt-2 text-white dark:text-white font-bold text-base md:text-lg leading-7 md:leading-8", children: portfolio.title }),
                  portfolio.type && /* @__PURE__ */ jsx("p", { className: "mt-2 text-gray-400 dark:text-gray-200 text-sm", children: portfolio.type })
                ]
              }
            )
          },
