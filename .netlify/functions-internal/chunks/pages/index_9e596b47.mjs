/* empty css                           */import { e as createAstro, f as createComponent, r as renderTemplate, i as renderComponent, j as renderSlot, k as renderHead, h as addAttribute, m as maybeRenderHead } from '../astro_415687b5.mjs';
import 'html-escaper';
...
import { $ as $$Image } from './generic_e8e1870b.mjs';
import '@astrojs/internal-helpers/path';
import 'mime/lite.js';
import '../astro-assets-services_ff981a9e.mjs';
  ...
  return /* @__PURE__ */ jsxs("footer", { className: "border-t-1 border-solid border-gray-100 dark:border-gray-50/[.10] dark:bg-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-screen-xl mx-auto py-10 px-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex md:grid justify-center md:justify-between items-center flex-col md:flex-row md:grid-cols-3", children: [
        /* @__PURE__ */ jsx("img", { className: "w-16", src: "/randyphalla-icon.png", alt: "Randy Phalla" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-7 text-center md:text-left", children: /* @__PURE__ */ jsx("p", { className: "text-sm md:text-base dark:text-white", children: "©2023 Randy Phalla" }) })
    ] })
  ] });
};
        ...
        children: /* @__PURE__ */ jsxs(Dialog.Panel, { className: "flex justify-center items-center flex-col md:flex-row w-full max-w-4xl	transform overflow-hidden p-6 rounded-lg bg-white dark:dark:bg-gray-900 shadow-xl transition-all", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "w-full md:max-w-lg md:pl-6", children: [
            ...
            portfolio?.siteLink && /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx("a", { className: "text-gray-600 dark:text-gray-400 text-sm md:text-base transition-all hover:text-gray-500", href: portfolio?.siteLink, target: "_blank", children: portfolio?.siteLink })
            ] }),
