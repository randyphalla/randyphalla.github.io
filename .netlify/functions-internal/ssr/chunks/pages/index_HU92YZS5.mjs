/* empty css                          */
import { e as createAstro, f as createComponent, r as renderTemplate, h as addAttribute, i as renderComponent, j as renderSlot, k as renderTransition, l as renderHead, n as fade, m as maybeRenderHead } from '../astro_Bmr3RRHV.mjs';
import 'kleur/colors';
import 'html-escaper';
...
import { $ as $$Image } from './generic_DQPox26A.mjs';
...
const $$Banner = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="py-10 md:py-36 dark:bg-gray-900"> <h3 class="hidden">Banner</h3> <div class="max-w-screen-xl mx-auto px-4 text-left"> <!-- <h4 class="text-gray-900 dark:text-white font-normal text-sm md:text-base">Hey, I'm</h4> --> <h5 class="text-gray-900 dark:text-white font-bold text-6xl md:text-7xl"><span class="gradient-text">${name}</span></h5> <h6 class="mt-2 text-gray-700 dark:text-gray-200 font-medium text-xl">${role}</h6> <!-- <p class="mt-2 text-gray-500 dark:text-gray-400 text-base">I specialize in responsive design, accessibility, and UI/UX.</p> --> <p class="mt-2 text-gray-500 dark:text-gray-400 text-base md:max-w-xl	">I specialize in responsive design, accessibility, and user experience.</p> </div> </section>`;
