...
const Portfolio = (props) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("section", { id: "portfolio", className: "py-10 px-4 md:px-8 bg-white dark:bg-gray-900", children: [
          ...
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("img", { className: "w-full h-full", src: portfolio.imgSrc, alt: portfolio.imgSrcAlt, loading: "lazy" }),
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  const portfolioItems = [
    ...
    {
      id: 5,
      imgSrc: "/portfolio/annex_thumbnail.png",
      imgSrcAlt: "The Annex",
      title: "The Annex",
      type: "Web",
      description: "I developed UI components and theming for the website, mentoring a junior developer in their use to build the site. My guidance covered best practices in layouts, animations, accessibility, and programming. Additionally, I deployed the website using Firebase Hosting.",
      client: "The Annex Hotel",
