				...
				<div className="container">
					...
					<div className="row justify-content-center description">
						<div className="col-12 col-sm-10 col-md-8">
							<p>
								<span>Front-End Developer</span> & <span>Graphic Designer</span> from <span>London, Ontario.</span>
							</p>
							<p>
								Currently working at
								<Link to="https://devlift.io" rel="noopener" target="_blank">
									Devlift Media
								</Link>
								as a <span>Front End Developer.</span>
							</p>
						</div>
					</div>
					...
					<div className="row coming-soon-message">
						<div className="col-12">
							<h3>
								Website work in progress <br /> ( Coming Soon )
							</h3>
						</div>
					</div>
